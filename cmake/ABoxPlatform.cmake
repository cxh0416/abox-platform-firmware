function(abox_platform_attach_components target)
    ...
    if(NOT ABOX_HARDWARE STREQUAL "stm32f105_ec800_v1")
    ...
    if(ABOX_PRODUCT_CONFIG_DIR)
        if(NOT EXISTS "${ABOX_PRODUCT_CONFIG_DIR}/abox_product_config.h")
            message(FATAL_ERROR "abox_platform_attach_components: missing product hardware contract")
        endif()
